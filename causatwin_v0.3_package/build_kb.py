"""
Build a drug target knowledge base for synthesis engine
50+ well-known targets with key profiles
"""
import json
...
# Drug target knowledge base (gene name → profile)
# Each profile includes: protein class, druggability, modality, key evidence, disease assoc
KNOWLEDGE_BASE = {
    # Cardiovascular
    "PCSK9": {
        ...
        "druggability_tier": 1,
        "modalities": ["antibody (approved)", "siRNA (approved)", "small molecule (in development)"],
        ...
        "diseases": ["Hypercholesterolemia", "ASCVD", "Familial hypercholesterolemia"],
    ...
    "LPA": {
        ...
        "druggability_tier": 1,
        "modalities": ["ASO (pelacarsen Phase 3)", "siRNA (olpasiran Phase 3)"],
        ...
        "diseases": ["Atherosclerotic cardiovascular disease", "Aortic stenosis", "Venous thromboembolism"],
    ...
    "ANGPTL3": {
        ...
        "druggability_tier": 1,
        "modalities": ["antibody (evinacumab approved HoFH)", "ASO (vupanorsen Phase 2)", "siRNA (ARO-ANG3 Phase 2)"],
        ...
        "diseases": ["Hypertriglyceridemia", "Homozygous familial hypercholesterolemia (HoFH)", "ASCVD"],
    ...
    "APOC3": {
        ...
        "druggability_tier": 1,
        "modalities": ["ASO (volanesorsen approved in EU)", "siRNA (ARO-APOC3 Phase 2)"],
        ...
        "diseases": ["Familial chylomicronemia syndrome (FCS)", "Hypertriglyceridemia", "ASCVD"],
    ...
    "CETP": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule (anacetrapib, evacetrapib)"],
        ...
        "diseases": ["Dyslipidemia", "ASCVD (failed trials)"],
    ...
    "IL6R": {
        ...
        "druggability_tier": 1,
        "modalities": ["antibody (tocilizumab, sarilumab approved)"],
        ...
        "diseases": ["Rheumatoid arthritis", "Juvenile idiopathic arthritis", "Castleman disease", "COVID-19", "ASCVD"],
    ...
    "TNF": {
        ...
        "druggability_tier": 1,
        "modalities": ["antibody (multiple approved)"],
        ...
        "diseases": ["Rheumatoid arthritis", "Crohn's disease", "Psoriasis", "Ankylosing spondylitis", "Ulcerative colitis"],
        "pathway_centrality": 9,
        "off_target_risk": 4,
        "tier": 1
    },
    "IL23R": {
        ...
        "druggability_tier": 1,
        "modalities": ["antibody (risankizumab, guselkumab, tildrakizumab approved)"],
    ...
    "JAK1": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule (multiple approved JAK inhibitors)"],
        ...
        "diseases": ["Rheumatoid arthritis", "Atopic dermatitis", "Ulcerative colitis", "Myelofibrosis", "Alopecia areata"],
        "pathway_centrality": 8,
        "off_target_risk": 5,
        "tier": 1
    },
    "JAK2": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule (ruxolitinib approved)"],
        ...
        "diseases": ["Polycythemia vera", "Essential thrombocythemia", "Primary myelofibrosis", "GVHD"],
        "pathway_centrality": 9,
        "off_target_risk": 4,
        "tier": 1
    },
    ...
    "GLP1R": {
        ...
        "druggability_tier": 1,
        "modalities": ["peptide agonist (semaglutide, liraglutide approved)"],
        ...
        "diseases": ["Type 2 diabetes", "Obesity", "ASCVD (semaglutide SELECT trial)", "NAFLD", "Alzheimer's (investigational)"],
        "pathway_centrality": 7,
        "off_target_risk": 7,
        "tier": 1
    },
    "GCGR": {
        ...
        "druggability_tier": 1,
        "modalities": ["antibody (LY2409021 Phase 2)", "small molecule (multiple in development)"],
        ...
        "diseases": ["Type 2 diabetes", "Hyperglycemia", "NAFLD"],
        "pathway_centrality": 5,
        "off_target_risk": 4,
        "tier": 2
    },
    "GPR40": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule agonist (fasiglifam halted 2016)"],
        ...
        "diseases": ["Type 2 diabetes (failed)"],
    ...
    "FFAR4": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule agonist"],
        ...
        "diseases": ["Obesity", "Type 2 diabetes", "NAFLD"],
        "pathway_centrality": 4,
        "off_target_risk": 6,
        "tier": 2
    },
    ...
    "BRAF": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule inhibitor (multiple approved)"],
        ...
        "diseases": ["Melanoma", "Colorectal cancer", "Thyroid cancer", "Hairy cell leukemia", "Lung cancer"],
        "pathway_centrality": 9,
        "off_target_risk": 6,
        "tier": 1
    },
    "EGFR": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule TKI (multiple approved)", "antibody (cetuximab, panitumumab, etc.)"],
        ...
        "diseases": ["Non-small cell lung cancer", "Colorectal cancer", "Head and neck cancer", "Glioblastoma"],
        "pathway_centrality": 9,
        "off_target_risk": 5,
        "tier": 1
    },
    "KRAS": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule (sotorasib, adagrasib approved for G12C)"],
        ...
        "diseases": ["Non-small cell lung cancer", "Colorectal cancer", "Pancreatic cancer", "Biliary tract cancer"],
    ...
    "ABL1": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule TKI (multiple approved)"],
        ...
        "diseases": ["Chronic myeloid leukemia (CML)", "Acute lymphoblastic leukemia (Ph+ ALL)", "GIST"],
        "pathway_centrality": 9,
        "off_target_risk": 5,
        "tier": 1
    },
    "BCR": {
        ...
        "druggability_tier": 2,
        "modalities": ["not directly targeted; ABL inhibitors address BCR-ABL"],
    ...
    "ALK": {
        ...
        "diseases": ["Non-small cell lung cancer", "Anaplastic large cell lymphoma", "Neuroblastoma", "Inflammatory myofibroblastic tumor"],
        "pathway_centrality": 8,
        "off_target_risk": 5,
        "tier": 1
    },
    "MET": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule TKI (capmatinib, tepotinib approved)", "antibody (emibetuzumab)"],
        ...
        "diseases": ["Non-small cell lung cancer", "Hepatocellular carcinoma", "Gastric cancer"],
        "pathway_centrality": 7,
        "off_target_risk": 4,
        "tier": 1
    },
    ...
    "F11": {
        ...
        "druggability_tier": 1,
        "modalities": ["antibody (abelacimab, osocimab Phase 3)", "ASO (fesomersen Phase 2)", "small molecule (milvexian Phase 2, asundexian failed 2024)"],
        ...
        "diseases": ["Venous thromboembolism", "Atrial fibrillation stroke prevention", "Major orthopedic surgery VTE"],
        "pathway_centrality": 6,
        "off_target_risk": 8,
        "tier": 1
    },
    "F2": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule (dabigatran approved)"],
        ...
        "diseases": ["Atrial fibrillation", "VTE", "Stroke prevention"],
        "pathway_centrality": 9,
        "off_target_risk": 5,
        "tier": 1
    },
    "F10": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule (rivaroxaban, apixaban, edoxaban approved)"],
        "approved_drugs": "Rivaroxaban, Apixaban, Edoxaban (all approved for VTE, AF)",
        "genetic_evidence": "Moderate.",
        "mr_strength": "Moderate.",
        "key_variants": "rs3211772 (intronic)",
        "diseases": ["Atrial fibrillation", "VTE", "ACS secondary prevention"],
        "pathway_centrality": 9,
        "off_target_risk": 4,
        "tier": 1
    },
    "SERPINC1": {
        ...
        "druggability_tier": 2,
        "modalities": ["replacement protein (antithrombin concentrate approved)"],
        ...
        "diseases": ["Hereditary antithrombin deficiency", "Heparin resistance", "VTE"],
        "pathway_centrality": 8,
        "off_target_risk": 7,
        "tier": 2
    },
    ...
    "SCN5A": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule (multiple antiarrhythmics)"],
        ...
        "diseases": ["Brugada syndrome", "Long QT syndrome type 3", "Cardiac conduction disease", "Sudden infant death syndrome"],
        "pathway_centrality": 9,
        "off_target_risk": 5,
        "tier": 1
    },
    "SCN9A": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule (in development)", "ASO (in development)"],
        ...
        "diseases": ["Chronic pain", "Neuropathic pain", "Erythromelalgia", "Inherited pain disorders"],
        "pathway_centrality": 6,
        "off_target_risk": 5,
        "tier": 1
    },
    "SLC6A4": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule (SSRIs)"],
        ...
        "diseases": ["Major depressive disorder", "Anxiety disorders", "OCD", "PTSD"],
        "pathway_centrality": 9,
        "off_target_risk": 4,
        "tier": 1
    },
    ...
    "APP": {
        ...
        "druggability_tier": 1,
        "modalities": ["antibody (lecanemab, aducanumab, donanemab)", "BACE inhibitor (failed)"],
        ...
        "diseases": ["Alzheimer's disease (early and late onset)"],
        "pathway_centrality": 8,
        "off_target_risk": 4,
        "tier": 1
    },
    "PSEN1": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule γ-secretase modulators (in development)"],
        ...
        "diseases": ["Early-onset familial Alzheimer's disease"],
        "pathway_centrality": 7,
        "off_target_risk": 4,
        "tier": 1
    },
    "SNCA": {
        ...
        "druggability_tier": 1,
        "modalities": ["antibody (prasinezumab Phase 2)", "ASO (in development)"],
    ...
    "LRRK2": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule TKI (multiple in development)"],
        ...
        "diseases": ["Parkinson's disease (familial and sporadic)", "Crohn's disease (some variants)"],
        "pathway_centrality": 6,
        "off_target_risk": 4,
        "tier": 1
    },
    "FAM171A2": {
        ...
        "druggability_tier": 2,
        "modalities": ["small molecule (bemcentinib repurposed for PD)", "antibody (theoretical)"],
        ...
        "diseases": ["Parkinson's disease (emerging)", "AML (preclinical)"],
        "pathway_centrality": 5,
        "off_target_risk": 5,
        "tier": 2
    },
    "GBA": {
        ...
        "druggability_tier": 1,
        "modalities": ["ERT (imiglucerase approved for Gaucher)", "small molecule chaperone (ambroxol, miglustat)"],
        ...
        "diseases": ["Gaucher disease (Type 1, 2, 3)", "Parkinson's disease (risk factor)"],
        "pathway_centrality": 4,
        "off_target_risk": 6,
        "tier": 1
    },
    "HTT": {
        ...
        "druggability_tier": 1,
        "modalities": ["ASO (tominersen halted 2021)", "ASO (AMT-130 gene therapy)"],
    ...
    "INSR": {
        ...
        "druggability_tier": 1,
        "modalities": ["recombinant insulin (approved)"],
        ...
        "mr_strength": "N/A (Mendelian).",
        "key_variants": "Multiple LoF",
        "diseases": ["Type 1 diabetes", "Type 2 diabetes", "Insulin resistance syndromes", "Donohue syndrome"],
        "pathway_centrality": 9,
        "off_target_risk": 5,
        "tier": 1
    },
    "PPARG": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule agonist (thiazolidinediones)"],
        ...
        "diseases": ["Type 2 diabetes", "NAFLD", "Metabolic syndrome"],
        "pathway_centrality": 8,
        "off_target_risk": 3,
        "tier": 1
    },
    "SGLT2": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule inhibitor (SGLT2 inhibitors)"],
        ...
        "diseases": ["Type 2 diabetes", "Heart failure (HFrEF, HFpEF)", "CKD", "Cardiovascular death"],
        "pathway_centrality": 5,
        "off_target_risk": 7,
        "tier": 1
    },
    "HMGCR": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule inhibitor (statins)"],
        ...
        "diseases": ["Hypercholesterolemia", "ASCVD", "Primary prevention of CVD"],
        "pathway_centrality": 8,
        "off_target_risk": 4,
        "tier": 1
    },
    "LDLR": {
        ...
        "druggability_tier": 1,
        "modalities": ["not directly targeted; PCSK9 inhibitors increase LDLR"],
        ...
        "diseases": ["Familial hypercholesterolemia", "ASCVD"],
        "pathway_centrality": 9,
        "off_target_risk": 9,
        "tier": 1
    },
    ...
    "TP53": {
        ...
        "druggability_tier": 3,
        "modalities": ["gene therapy (in development)", "small molecule reactivators (PRIMA-1/MAPR)"],
        ...
        "diseases": ["Most cancers (somatic)", "Li-Fraumeni syndrome (germline)"],
        "pathway_centrality": 10,
        "off_target_risk": 2,
        "tier": 2,
    ...
    "MYC": {
        ...
        "druggability_tier": 4,
        "modalities": ["none direct (transcription factor, traditionally undruggable)", "BET inhibitors (downstream)"],
        ...
        "diseases": ["Burkitt lymphoma (t(8;14))", "Neuroblastoma (MYCN)", "Multiple carcinomas"],
        "pathway_centrality": 10,
        "off_target_risk": 1,
        "tier": 3,
    ...
    "BRCA1": {
        ...
        "druggability_tier": 2,
        "modalities": ["PARP inhibitors (indirect, in BRCA-deficient cancers)"],
        ...
        "diseases": ["Hereditary breast cancer", "Hereditary ovarian cancer", "BRCA1/2-deficient cancers (PARPi responsive)"],
        "pathway_centrality": 9,
        "off_target_risk": 6,
        "tier": 1
    },
    "BRCA2": {
        ...
        "druggability_tier": 2,
        "modalities": ["PARP inhibitors (indirect)"],
        ...
        "diseases": ["Hereditary breast cancer", "Hereditary ovarian cancer", "Hereditary prostate cancer", "Hereditary pancreatic cancer"],
        "pathway_centrality": 9,
        "off_target_risk": 6,
        "tier": 1
    },
    ...
    "JAK3": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule inhibitor (decernotinib, ritlecitinib)"],
        "approved_drugs": "Ritlecitinib (Pfizer, alopecia areata)",
        "genetic_evidence": "Strong. JAK3 LoF → SCID (autosomal recessive).",
        "mr_strength": "N/A (Mendelian).",
        "key_variants": "Multiple LoF",
        "diseases": ["Alopecia areata", "RA", "Psoriasis", "Ulcerative colitis", "SCID (germline)"],
        "pathway_centrality": 7,
        "off_target_risk": 4,
        "tier": 1
    },
    "TYK2": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule (deucravacitinib allosteric approved)"],
        ...
        "diseases": ["Plaque psoriasis", "Psoriatic arthritis", "Lupus", "IBD (Crohn's, UC)"],
        "pathway_centrality": 7,
        "off_target_risk": 6,
        "tier": 1
    },
    "IDO1": {
        ...
        "druggability_tier": 1,
        "modalities": ["small molecule inhibitor (epacadostat failed Phase 3)"],
        ...
        "diseases": ["Melanoma (failed)", "Renal cell carcinoma", "Hematologic malignancies"],
        "pathway_centrality": 4,
        "off_target_risk": 3,
        "tier": 3,
    ...
    "STAT3": {
        ...
        "druggability_tier": 2,
        "modalities": ["ASO (in development)", "small molecule (in development)"],
        ...
        "mr_strength": "N/A (Mendelian).",
        "key_variants": "Multiple LoF/GoF",
        "diseases": ["Cancer (many types, somatic)", "Hyper-IgE syndrome (germline)", "Autoimmune lymphoproliferative syndrome"],
        "pathway_centrality": 9,
        "off_target_risk": 3,
        "tier": 2
    },
    "IL4R": {
        ...
        "druggability_tier": 1,
        "modalities": ["antibody (dupilumab blocks IL4Rα)"],
        ...
        "diseases": ["Atopic dermatitis", "Asthma", "Chronic rhinosinusitis with nasal polyps", "Eosinophilic esophagitis", "Prurigo nodularis"],
        "pathway_centrality": 6,
        "off_target_risk": 5,
        "tier": 1
    },
    ...
    "Lp-PLA2": {
        ...
        "druggability_tier": 2,
        "modalities": ["small molecule inhibitor (darapladib failed 2014)"],
        ...
        "diseases": ["Atherosclerosis (failed target)"],
        "pathway_centrality": 3,
        "off_target_risk": 5,
        "tier": 3,
...
# Save knowledge base
with open(OUT / 'target_knowledge_base.json', 'w', encoding='utf-8') as f:
    json.dump({k: v for k, v in KNOWLEDGE_BASE.items() if v is not None},
              f, ensure_ascii=False, indent=2)

# Stats
n_total = len(KNOWLEDGE_BASE)
n_valid = len([k for k, v in KNOWLEDGE_BASE.items() if v is not None])
print(f"Knowledge base built: {n_valid} targets (out of {n_total} keys)")
print(f"  Saved: {OUT / 'target_knowledge_base.json'}")
print(f"  Size: {(OUT / 'target_knowledge_base.json').stat().st_size:,} bytes")
